...
class tape_follow():
	...
	#(between tags) passed to it in the parameter
		...
		rospy.loginfo("Speed is ")
		rospy.loginfo(drive_msg.speed)
		rospy.loginfo("Steering angle is ")
